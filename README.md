...
\* This module itself only currently supports `da`, `en`, `de`, `it`, `nb` and `nl` for the text 'Day after', 'Kph' and 'Mph'.  If you have translations for these please send them over and I'll add your language to the set I can support :)
